...
/**By Yaovi SAMAH , 
 ** https://yaovisamah.com | info@yaovisamah.com
...
class PatientsController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		$fields = array('id', 	'first_name', 	'last_name', 	'gender', 	'generated_id', 	'facilitie', 	'doctor_name', 	'registration_date');
		...
		if(!empty($this->search)){
			...
			$db->orWhere('facilitie',"%$text%",'LIKE');
			$db->orWhere('doctor_name',"%$text%",'LIKE');
	...
	function edit($rec_id=null){
		...
		if(is_post_request()){
			...
			$fields=array('id','first_name','last_name','gender','facilitie','doctor_name','registration_date');
			$db->where('id' , $rec_id);
