<?php
	...
	define('SITE_NAME' , "PATIENTS-SYSTEM");
	...
	define('APP_ID',"446f287930ed7634b97662a937637938");
	...
	define('USER_PHOTO',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['picture'] : null ));
	define('USER_ROLE',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['user_role'] : null ));
